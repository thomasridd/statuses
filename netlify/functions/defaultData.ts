...
export const defaultStatuses: Status[] = [
  ...
  // Family
  { id: 'online_grocery_shop', label: 'Online grocery shop 📱', motive_id: 'family', type: 'value', unit: '£', default_value: 80, enabled: true, order: 1, pinned: false, status_category: 'task' },
